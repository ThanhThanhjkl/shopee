<style>
    ...
    <?php include "./assets/css/payment.css" ?>
...
<body>
    ...
    curl_setopt_array(
        ...
        array(
            ...
            CURLOPT_HTTPHEADER => array(
                "Authorization: Bearer 8589a916d740f6c27e90aba1f088bd42",
    ...
    <footer class="footer">
        ...
        <div class="container">
            ...
            <p class="infor_footer">Chịu Trách Nhiệm Quản Lý Nội Dung: Nguyễn Đức Trí - Điện thoại liên hệ: 024 73081221
                (ext 4678)</p>
            <p class="infor_footer">Mã số doanh nghiệp: 0106773786 do Sở Kế hoạch & Đầu tư TP Hà Nội cấp lần đầu ngày
                10/02/2015</p>
        </div>
